...
const GameActionService_1 = require("../services/GameActionService");
exports.actionRoutes = (0, express_1.Router)();
/**
 * Trade in cards for armies
 * POST /api/games/:gameId/trade-cards
 */
exports.actionRoutes.post('/:gameId/trade-cards', (req, res) => {
    try {
        ...
        const gameState = GameActionService_1.gameActionService.tradeCards(gameId, playerId, cardIds);
        res.status(200).json({
            game: gameState
        });
    }
 ...
 */
exports.actionRoutes.post('/:gameId/place-reinforcements', (req, res) => {
    try {
        const { gameId } = req.params;
        ...
        const gameState = GameActionService_1.gameActionService.placeReinforcements(gameId, playerId, placements);
        res.status(200).json({
            game: gameState
        });
    }
 ...
 */
exports.actionRoutes.get('/:gameId/reinforcements', (req, res) => {
    try {
        const { gameId } = req.params;
        ...
        const info = GameActionService_1.gameActionService.getReinforcementInfo(gameId, playerId);
 ...
 */
exports.actionRoutes.post('/:gameId/end-reinforcement', (req, res) => {
    try {
        const { gameId } = req.params;
        ...
        const gameState = GameActionService_1.gameActionService.endReinforcementPhase(gameId, playerId);
        res.status(200).json({
            game: gameState
        });
    }
 ...
 */
exports.actionRoutes.post('/:gameId/attack', (req, res) => {
    try {
        const { gameId } = req.params;
        ...
        const result = GameActionService_1.gameActionService.attack(gameId, playerId, from, to);
        res.status(200).json({
            game: result.game,
 ...
 */
exports.actionRoutes.post('/:gameId/auto-attack', (req, res) => {
    try {
        const { gameId } = req.params;
        const { playerId, from, to } = req.body;
        if (!playerId || !from || !to) {
        ...
        const result = GameActionService_1.gameActionService.autoAttack(gameId, playerId, from, to);
        res.status(200).json({
            game: result.game,
            attackResult: result.attackResult
        });
 ...
 */
exports.actionRoutes.post('/:gameId/move-armies', (req, res) => {
    try {
        const { gameId } = req.params;
        ...
        const gameState = GameActionService_1.gameActionService.moveArmies(gameId, playerId, from, to, armies);
        res.status(200).json({
            game: gameState
        });
    }
 ...
 */
exports.actionRoutes.post('/:gameId/end-attack', (req, res) => {
    try {
        const { gameId } = req.params;
        const { playerId } = req.body;
        if (!playerId) {
        ...
        const gameState = GameActionService_1.gameActionService.endAttackPhase(gameId, playerId);
        res.status(200).json({
            game: gameState
        });
    }
 ...
 */
exports.actionRoutes.post('/:gameId/fortify', (req, res) => {
    try {
        const { gameId } = req.params;
        const { playerId, from, to, armies } = req.body;
        if (!playerId || !from || !to || armies === undefined) {
        ...
        const gameState = GameActionService_1.gameActionService.fortify(gameId, playerId, from, to, armies);
        res.status(200).json({
            game: gameState
        });
    }
 ...
 */
exports.actionRoutes.post('/:gameId/end-turn', (req, res) => {
    try {
        const { gameId } = req.params;
        const { playerId } = req.body;
        if (!playerId) {
        ...
        const gameState = GameActionService_1.gameActionService.endTurn(gameId, playerId);
        res.status(200).json({
            game: gameState,
